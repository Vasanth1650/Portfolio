...
function BigAd(color) {
    const [position, setPosition] = useState([-0.9, -1.2, 1]);
    ...
    return (
        <div style={{ marginLeft: "650px", marginBottom: "20px" }}
            className="absolute mt-5  p-4"

        >
            <div
                style={{ width: "620px", userSelect: "none", height: "320px" }}
                className="modelBackAd absolute top-4 right-4 w-96 bg-white-100 shadow-lg rounded-lg overflow-hidden flex"
            >
                <div style={{ zIndex: "1" }} className=" absolute mt-64 ml-10 bg-transparent h-2">
                    <div className="flex">
                        <label className="block text-xs font-bold text-white">Open</label>
                        <label className="block absolute top-13 text-white font-bold text-xs right-5">Close</label>
                        <svg style={{ width: "50px", position: "absolute", marginTop: "-310px", marginLeft: "500px", color: "white", backgroundColor: "white" }} xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 70 70" viewBox="0 0 70 70" id="360-degree-rotate">
				...
				C43.5390625,16.7127361,38.8291016,12.0027752,33.0390625,12.0027752z"></path>
                    ...
                    <input
                        ...
                        className="w-96 h-2 bg-white-200 p-2 rounded-lg appearance-none cursor-pointer"
                    />
